...
generate: early-init.el init.el init-ui.el init-base.el init-completion.el

clean:
	rm -f init.el early-init.el init-ui.el init-base.el init-completion.el elisp/*.el
