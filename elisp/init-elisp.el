...
Lisp function does not specify a special indentation."
    ...
    (defun add-button-to-remove-advice (buffer-on-name function)
    ...
    (defun remove-hook-at-point ()
      "Remove the hook at the point int the *Help* buffer."
      (interactive)
...
(use-package helpful
  ...
  (with-no-warnings
    (with-eval-after-load 'apropos
      ;; path apropos buttons to call helpful instead of help
  ...
  (with-no-warnings
    ...
    (defun my-helpful--navigate (button)
      ...
      ;; We use `get-text-property' to work around a Emacs 25 bug:
