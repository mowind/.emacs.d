...
(use-package symbol-overlay
  ...
  (symbol-overlay-face-4 ((t (:inherit nerd-icons-purpe :background unspecified :foreground unspecified :inverse-video t))))
...
(use-package diff-hl
  ...
  (with-no-warnings
    ...
    (unless (display-graphic-p)
      ;; Fall back to the display margin since the fringe is unvaliable in tty
